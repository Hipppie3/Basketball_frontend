 ...
 {player.stats.map((stat) => (
        <div key={stat.id}>
            ...
            <div className="game-row">
              <div className="game-date">JAN 22, 2023</div>
              <div className="game-matchup">MEM @ PHX</div>
              <div className="game-outcome">L</div>
              <div className="fgm">1</div>
              <div className="fga">10</div>
               <div className="fgp">33%</div>
              <div className="twoPM">20</div>
              <div className="twoPA">30</div>
              <div className="threePM">0</div>
              <div className="threePA">1</div>
              <div className="oReb">20</div>
              <div className="dReb">10</div>
              <div className="reb">30</div>
              <div className="ast">2</div>
              <div className="stl">1</div>
              <div className="blk">1</div>
              <div className="to">5</div>
              <div className="pts">10</div>
